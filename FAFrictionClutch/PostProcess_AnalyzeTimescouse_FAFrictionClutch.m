...
% of the FA friction clutch model. The specified directory
% "SimulationDirectory" contains the data for each simulation in a
% parameter sweep. See ParamSweep_FAFrictionClutch_Velocity.m for an
...
for simID = ParamSweep.simID'
    ...
    % Force over Vcl = Force over Vcl:Factin bond = Force over Vcl:Tal bond.
